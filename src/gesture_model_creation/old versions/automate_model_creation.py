...
def draw_line(image, point1, point2, color_outer, color_inner, thickness_outer=6, thickness_inner=2):
...
def draw_circle(image, point, color_outer, color_inner, radius, thickness_outer=-1, thickness_inner=1):
    ...
    if len(landmark_point) > 0:
        ...
        for part in finger_parts:
            for i in range(len(part) - 1):
                draw_line(image, landmark_point[part[i]], landmark_point[part[i+1]], (0, 0, 0), (255, 255, 255))

    for index, landmark in enumerate(landmark_point):
        draw_circle(image, landmark, (255, 255, 255), (0, 0, 0), 8 if index % 4 == 0 else 5)
