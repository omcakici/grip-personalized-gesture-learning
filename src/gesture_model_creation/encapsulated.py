...
class GestureClassifier:
    ...
    # Replace `def function_name():` with `def function_name(self):`
    # You have to replace this in all your function definitions
    # Don't forget to also replace any calls to these functions
    # For example, replace `function_name()` with `self.function_name()`
    
    # Replace the `main` function with `run`
    def run(self):
